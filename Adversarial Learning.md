...
### Author
Jinyin Chen, Ziqiang Shi, Yangyang Wu, Xuanheng Xu and Haibin Zheng
### Venue
Arxiv, 2018, https://arxiv.org/abs/1810.01110
### Algorithm
...
### Target Model
GAE, DeepWalk, node2vec, CN, RA, Katz and Local Random Walk
...
### Abstract
This paper proposed a attack algorithm named *Iterative gradient attack* (IGA), which based on *graph auto-encoder* (GAE). It's the first time link prediction adversarial attack problem is defined and attack method is brought up.
...
### Author
Hanjun Dai, Hui Li, Tian Tian, Xin Huang, LinWang, Jun Zhu, Le Song
### Venue
ICML, 2018, https://arxiv.org/abs/1806.02371
### Algorithm
...
### Venue
SIGKDD, 2018, https://arxiv.org/abs/1805.07984
### Algorithm
...
### Abstract
This paper presented the first work on adversarial attacks to (attributed) graphs, specifically focusing on the task of node classification via graph convolutional networks. The attacks target the nodes’ features and the graph structure, and there are two types of attacks: direct and influencer attacks.The classification performance is consistently reduced, even when only partial knowledge of the graph is available or the attack is restricted to a few influencers. The detail of the algorithm is:
...
### Author
Kaidi Xu1, Hongge Chen2， Sijia Liu3, Pin-Yu Chen3, Tsui-Wei Weng2, Mingyi Hong4 and Xue Lin1
### Venue
IJCAI, 2019, https://arxiv.org/abs/1906.04214
### Algorithm
+ Attack
...
None
### Abstract
This paper first present a novel gradient-based topology attack framework that overcomes the difficulty of attacking discrete graph structure data a first-order optimization perspective, the attack framework which under two attacking scenarios:
+ Attacking a pre-defined GNN
+ Attacking a re-trainable GNN
...
### Author
Jinyin Chen, Yangyang Wu, Xuanheng Xu, Yixian Chen, Haibin Zheng, and Qi Xuan IEEE Member
### Venue
Arxiv, 2018, https://arxiv.org/abs/1809.02797
### Algorithm
...
### Venue
Arxiv, 2018, https://arxiv.org/abs/1810.12881
### Algorithm
...
### Venue
ICLR, 2019, https://arxiv.org/abs/1902.08412
### Algorithm
...
### Code
https://www.kdd.in.tum.de/research/gnn-meta-attack/
...
### Venue
ICML, 2019, https://arxiv.org/abs/1809.01093
### Algorithm
...
### Code
https://www.kdd.in.tum.de/research/node_embedding_attack/

### Abstract
This paper provide the first adversarial vulnerability analysis on the widely used family of node embedding methods based on random walks. By exploiting results from eigenvalue perturbation theory, they can efficiently calculate the loss when graph changed, and avoids
