...
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|ICLR<br>2019|<a class="toc" id ="1"></a>[[1]](https://arxiv.org/abs/1902.08412)<br>[🔙](#toc)|Meta-Self<br>Meta-Train|Meta Gradient based on GCN|Poision<br>Topology<br>W & B -box|Node Classification|GCN<br>CLN<br>DeepWalk|DICE<br>NETTACK<br>First-order|Misclassification Rate<br>Accuracy |Cora<br>CiteSeer<br>PolBlogs<br>PubMed|[Link](https://www.kdd.in.tum.de/research/gnn-meta-attack/)|
...
|Arxiv<br>2019|<a class="toc" id ="8"></a>[[8]](https://arxiv.org/abs/1903.00553)<br>[🔙](#toc)|-|Based on LinLBP|Poision<br>Topology<br>W & B -box|Node Classification<br>Detection Evade|LinLBP<br>JWP<br>LBP<br>RW<br>LINE<br>DeepWalk<br>Node2vec<br>GCN|RA<br>NETTACK|FNR <br>FPR |Facebook<br>Enron<br>Epinions<br>Twitter<br>Google+|-|
...
|Arxiv<br>2018|<a class="toc" id ="10"></a>[[10]](https://arxiv.org/abs/1810.10751)<br>[🔙](#toc)|Greedy<br>Greedy GAN|Gradient based on GCN, GAN|Poision<br>Topology<br>Feature<br>White-box|Node Classification|GCN|RA|Accuracy<br>F1 Score<br>ASR |Cora<br>CiteSeer|-
