...
|[📝Arxiv](https://arxiv.org/abs/2003.05822)|Topological Effects on Attacks Against Vertex Classification|StratDegree,GreedyCover |  GreedyCover | Perpocessing-based | Node Classification | GCN | Number of Trained Neighbors<br> with Random Selection | Required budget,Median margin  | Cora,Citeseer, Pubmed,Polblogs |
