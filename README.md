...
|[📝CIKM](https://arxiv.org/abs/2008.08692)|Enhancing Graph Neural Network-based Fraud Detectors against Camouflaged Fraudsters| CARE-GNN | Reinforcement learning | Hybrid | Target Task | GCN,GAT,RGCN,GraphSAGE | GeniePath, Player2Vec, <br>SemiGNN,GraphConsis| AUC,Recall | Yelp, Amazon |
