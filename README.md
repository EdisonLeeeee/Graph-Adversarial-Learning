...
+ [Attack](#attack)
    + [1] [Multiscale Evolutionary Perturbation Attack on Community Detection](#1)
    + [2] [A Unified Framework for Data Poisoning Attack to Graph-based Semi-supervised Learning](#2)
    + [3] [A Restricted Black-box Adversarial Framework Towards Attacking Graph Embedding Models](#3)
    + [4] [Adversarial Attacks on Graph Neural Networks via Meta Learning](#1)
    + [5] [Adversarial Attacks on Node Embeddings via Graph Poisoning](#5)
    + [6] [Attacking Graph Convolutional Networks via Rewiring](#6)
    + [7] [Topology Attack and Defense for Graph Neural Networks: An Optimization Perspective](#7)
    ...
    + [13] [$\alpha$cyber: Enhancing Robustness of Android Malware Detection System Against Adversarial Attacks on Heterogeneous Graph Based Model](#13)
    ...
    + [21] [Fast Gradient Attack on Network Embedding](#18)
...
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|Arxiv<br>2019|<a class="toc" id ="1"></a>[[1]](https://arxiv.org/abs/1902.08412)<br>[🔙](#toc1)|xxx|xxx|xxx|xxx|xxx|xxx|xxx|xxx|
|NIPS<br>2019|<a class="toc" id ="2"></a>[[2]](https://arxiv.org/abs/1902.08412)<br>[🔙](#toc1)|xxx|xxx|xxx|xxx|xxx|xxx|xxx|xxx|
|Arxiv<br>2019|<a class="toc" id ="3"></a>[[3]](https://arxiv.org/abs/1902.08412)<br>[🔙](#toc1)|xxx|xxx|xxx|xxx|xxx|xxx|xxx|xxx|
