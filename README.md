...
|IJCAI<br>2019|<a class="toc" id ="4"></a>[[4]](https://arxiv.org/abs/1906.04214)<br>[🔙](#toc)|PGD<br>Min-Max|Gradient based|Poision<br>Evasion<br>Topology<br>W & B -box|Node Classification|GCN|DICE<br>Meta-Self<br>Greedy|Misclassification rate(+)<br>Accuracy|Cora<br>Citeseer|[Link](https://github.com/KaidiXu/GCN_ADV_Train)|
