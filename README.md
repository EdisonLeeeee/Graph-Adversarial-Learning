...
+ [Attack](#attack)
    ...
    + [5] [Attacking Graph Convolutional Networks via Rewiring](#5)
    + [6] [Topology Attack and Defense for Graph Neural Networks: An Optimization Perspective](#6)
    + [7] [Unsupervised Euclidean Distance Attack on Network Embedding](#7)
    + [8] [Generalizable Adversarial Attacks Using Generative Models](#8)
    + [9] [Data Poisoning Attack Against Knowledge Graph Embedding](#9)
    + [10] [Attacking Graph-Based Classification via Manipulating the Graph Structure](#10)
    + [11] [Ga Based Q-Attack on Community Detection](#11)
    + [12] [αcyber: Enhancing Robustness of Android Malware Detection System Against Adversarial Attacks on Heterogeneous Graph Based Model](#12)
    + [13] [Data Poisoning Attacks on Neighborhood-based Recommender Systems](#13)
    + [14] [Adversarial Recommendation: Attack of the Learned Fake Users](#14)
    + [15] [Attack Graph Convolutional Networks by Adding Fake Nodes](#15)
    + [16] [Attack Tolerance of Link Prediction Algorithms: How to Hide Your Relations in A Social Network](#16)
    + [17] [Link Prediction Adversarial Attack](#17)
    + [18] [Adversarial Attack on Graph Structured Data](#18)
    + [19] [Adversarial Attacks on Neural Networks for Graph Data](#19)
    + [20] [Fast Gradient Attack on Network Embedding](#20)
    + [21] [Data Poisoning Attack Against Unsupervised Node Embedding Methods](#21)
    + [22] [Attacking Similarity-Based Link Prediction in Social Networks](#22)
    + [23] [Practical Attacks Against Graph-Based Clustering](#23)
...
|Arxiv<br>2019|<a class="toc" id ="5"></a>[[5]](https://arxiv.org/abs/1906.03750)<br>[🔙](#toc1)|ReWatt|Reinforcement learning based on GCN|Graph Classification|GCN|RL-S2V,<br>RA|ASR |REDDIT-MULTI-12K,<br>REDDIT-MULTI-5K,<br>IMDB-MULTI|-|
|IJCAI<br>2019|<a class="toc" id ="6"></a>[[6]](https://arxiv.org/abs/1906.04214)<br>[🔙](#toc1)|PGD<br>Min-Max|Gradient-based GCN|Node Classification|GCN|DICE,<br>Meta-Self,<br>Greedy|Misclassification Rate |Cora,<br>Citeseer|[Link](https://github.com/KaidiXu/GCN_ADV_Train)|
|Arxiv<br>2019|<a class="toc" id ="7"></a>[[7]](https://arxiv.org/abs/1905.11015)<br>[🔙](#toc1)|EDA|Genetic algorithm based on DeepWalk|Node Classification,<br>Community Detection|HOPE,<br>LPA,<br>EM,<br>DeepWalk|RA,<br>DICE,<br>RLS,<br>DBA|NMI,<br>Micro-F1,<br>Macro-F1|Karate,<br>Game,<br>Dolphin|-|
|Arxiv<br>2019|<a class="toc" id ="8"></a>[[8]](https://arxiv.org/abs/1905.10864)<br>[🔙](#toc1)|DAGAER|Generative model based on VGAE|Node Classification|GCN|NETTACK|ASR |Cora<br>CiteSeer|-|
|IJCAI<br>2019|<a class="toc" id ="9"></a>[[9]](https://arxiv.org/abs/1904.12052)<br>[🔙](#toc1)|-|Knowledge embedding|Fact Plausibility Prediction|TransE,<br>TransR,<br>RESCAL|RA|MRR,<br>HR@K|FB15k,<br>WN18|-|
|CCS<br>2019|<a class="toc" id ="10"></a>[[10]](https://arxiv.org/abs/1903.00553)<br>[🔙](#toc1)|-|Based on LinLBP|Node Classification,<br>Evasion|LinLBP, JWP,<br>LBP, RW, LINE,<br>DeepWalk,<br>Node2vec,<br>GCN|RA,<br>NETTACK|FNR ,<br>FPR |Facebook,<br>Enron,<br>Epinions,<br>Twitter,<br>Google+|-|
|TCSS<br>2019|<a class="toc" id ="11"></a>[[11]](https://arxiv.org/abs/1811.00430)<br>[🔙](#toc1)|Q-Attack|Genetic algorithm|Community Detection|FN, Lou, SOA,<br>LPA, INF,<br>Node2vec+KM|RA,<br>CDA,<br>DBA|Modularity Q,<br>NMI|Karate,<br>Dolphins,<br>Football,<br>Polbooks|-|
|CIKM<br>2019|<a class="toc" id ="12"></a>[[12]](https://dl_acm.xilesou.top/citation.cfm?id=3357875)<br>[🔙](#toc1)|HG-Attack|Label propagation algorithm<br>Adding fake nodes|Malware Detection|Orig-HGC|AN-Attack|TP, TN, FP, FN, F1, <br>Precision, Recall, Accuracy|Tencent Security Lab Dataset|-|
|Arxiv<br>2019|<a class="toc" id ="13"></a>[[13]](https://arxiv.org/abs/1912.04109)<br>[🔙](#toc1)|UNAttack|Gradient-based similarity method<br>Adding fake nodes|Recommendation|Memory-based CF,<br>BPRMF, NCF|-|Hit@K|Filmtrust,<br>Movielens,<br>Amazon|-|
|Arxiv<br>2018|<a class="toc" id ="14"></a>[[14]](https://arxiv.org/abs/1809.08336)<br>[🔙](#toc1)|-|Gradient-based GAN, MF<br>Adding fake nodes|Recommendation|MF|Random, Average, Popular, Co-visitation|Attack Difference,<br>TVD, JS, Est., <br>Rank Loss @K,<br>Adversarial loss|Movielens 100K,<br>Movielens 1M|-|
|Arxiv<br>2018|<a class="toc" id ="15"></a>[[15]](https://arxiv.org/abs/1810.10751)<br>[🔙](#toc1)|Greedy<br>Greedy GAN|Gradient-based GCN, GAN|Node Classification|GCN|RA|Accuracy, <br>F1 Score, ASR |Cora, <br>Citeseer|-
|Arxiv<br>2018|<a class="toc" id ="16"></a>[[16]](https://arxiv.org/abs/1809.00152)<br>[🔙](#toc1)|CTR<br>OTC|Neighbour score based on graph structure|Link Prediction|Traditional Link Prediction Algs|-|AUC, AP|WTC 9/11,<br>ScaleFree,<br>Facebook,<br>Random network|-|
|Arxiv<br>2018|<a class="toc" id ="17"></a>[[17]](https://arxiv.org/abs/1810.01110)<br>[🔙](#toc1)|IGA|Gradient-based  GAE|Link Prediction|GAE, LRW <br>DeepWalk, <br>Node2vec, <br>CN, RA, Katz|RAN, <br>DICE, <br>GA|ASR , <br>AML|NS, <br>Yeast, <br>FaceBook|-|
|ICML<br>2018|<a class="toc" id ="18"></a>[[18]](https://arxiv.org/abs/1806.02371)<br>[🔙](#toc1)|RL-S2V|Reinforcement learning|Node/Graph Classification|GCN,<br>GNN|Random Sampling|Accuracy|Citeseer, <br>Cora, <br>Pubmed, <br>Finance|[Link](https://github.com/Hanjun-Dai/graph_adversarial_attack)
|KDD<br>2018|<a class="toc" id ="19"></a>[[19]](https://arxiv.org/abs/1805.07984)<br>[🔙](#toc1)|Nettack|Fast computation <br>based on GCN|Node Classification|GCN,<br>CLN,<br>DeepWalk|Rnd,<br>FGSM|Classification Margin,<br>Accuracy|Cora-ML,<br>Citeseer,<br>PolBlogs|[Link](https://github.com/danielzuegner/nettack)|
|Arxiv<br>2018|<a class="toc" id ="20"></a>[[20]](https://arxiv.org/abs/1809.02797)<br>[🔙](#toc1)|FGA|Gradient-based GCN|Node Classification,<br>Community Detection|GCN,<br>GraRep,<br>DeepWalk,<br>Node2vec,<br>LINE,<br>GraphGAN|RA,<br>DICE,<br>NETTACK|ASR, AML|Cora,<br>Citeseer,<br>PolBlogs|-|
|Arxiv<br>2018|<a class="toc" id ="21"></a>[[21]](https://arxiv.org/abs/1810.12881)<br>[🔙](#toc1)|Opt-attack|Gradient based on DeepWalk, LINE|Link Prediction|DeepWalk<br>LINE<br>Node2vec<br>SC<br>GAE|RA<br>PageRank<br>Degree sum<br>Shortest path|Similarity Score <br>AP|Facebook<br>Cora<BR>Citeseer|-|
|AAMAS<br>2018|<a class="toc" id ="22"></a>[[22]](https://arxiv.org/abs/1809.08368)<br>[🔙](#toc1)|Approx-Local|Similarity methods|Link Prediction|Local&Global similarity metrics|RandomDel,<br>GreedyBase|Katz Similarity,<br>ACT Distance,<br>Similarity Score|Random network,<br>Facebook|-|
|CCS<br>2017|<a class="toc" id ="23"></a>[[23]](https://arxiv.org/abs/1708.09056)<br>[🔙](#toc1)|Targeted noise injection,<br>Small community attack|Noise injection|Graph Clustering,<br>Community Detection|SVD,<br>Node2vec,<br>Community Detection Algs|-|ASR FPR |Reverse Engineered DGA Domains,<br>NXDOMAIN|-|
...
|[4] [Adversarial Attacks on Node Embeddings via Graph Poisoning](#4)|⭕|⭕|⭕|⭕|⭕|❌|⭕|❌|
|[5] [Attacking Graph Convolutional Networks via Rewiring](#5)|❌|⭕|⭕|⭕|❌|⭕|⭕|❌|
|[6] [Topology Attack and Defense for Graph Neural Networks: An Optimization rspective](#6)|❌|⭕|⭕|⭕|⭕|❌|⭕|❌|
|[7] [Unsupervised Euclidean Distance Attack on Network Embedding](#7)|❌|⭕|⭕|⭕|⭕|❌|⭕|❌
|[8] [Generalizable Adversarial Attacks Using Generative Models](#8)|⭕|❌|❌|⭕|❌|⭕|❌|⭕
|[9] [Data Poisoning Attack Against Knowledge Graph Embedding](#9)|⭕|❌|⭕|❌|⭕|❌|⭕|❌|
|[10] [Attacking Graph-Based Classification via Manipulating the Graph Structure](#10)|⭕|❌|⭕|⭕|⭕|❌|⭕|❌|
...
|[14] [Adversarial Recommendation: Attack of the Learned Fake Users](#14)|
|[15] [Attack Graph Convolutional Networks by Adding Fake Nodes](#15)|⭕|⭕|❌|⭕|⭕|❌|⭕|⭕|
|[16] [Attack Tolerance of Link Prediction Algorithms: How to Hide Your Relations in Social Network](#16)|⭕|❌|⭕|❌|❌|⭕|⭕|❌|
|[17] [Link Prediction Adversarial Attack](#17)|⭕|❌|⭕|⭕|❌|⭕|⭕|❌|
|[18] [Adversarial Attack on Graph Structured Data](#18)|⭕|❌|⭕|⭕|❌|⭕|⭕|❌|
|[19] [Adversarial Attacks on Neural Networks for Graph Data](#19)|⭕|❌|⭕|⭕|⭕|❌|⭕|⭕|
|[20] [Fast Gradient Attack on Network Embedding](#20)|⭕|❌|⭕|⭕|⭕|❌|⭕|❌|
